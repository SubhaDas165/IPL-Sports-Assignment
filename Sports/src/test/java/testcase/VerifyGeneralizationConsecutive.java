...
import pages.GeneralizeConsecutive;
...
public class VerifyGeneralizationConsecutive {
	Browser_Launch bl;
	WebDriver driver=null;
  @Test
  public void verifyGeneralizationConsecutive() {
	  GeneralizeConsecutive gc=new GeneralizeConsecutive(driver);
	  for (int i = 1; i <=10; i++) {
		gc.consecutiveLossesWins(i);
	}
  }
  @BeforeSuite
